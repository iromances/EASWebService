...
public class EASLoginProxyServiceLocator extends org.apache.axis.client.Service implements mypackage.EASLoginProxyService {
    ...
    private java.lang.String EASLogin_address = "http://10.10.116.14/ormrpc/services/EASLogin";
    ...
    public mypackage.EASLoginProxy getEASLogin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.EASLoginSoapBindingStub _stub = new mypackage.EASLoginSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypackage.EASLoginProxy.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.EASLoginSoapBindingStub _stub = new mypackage.EASLoginSoapBindingStub(new java.net.URL(EASLogin_address), this);
                _stub.setPortName(getEASLoginWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://10.10.116.14:6888/ormrpc/services/EASLogin", "EASLoginProxyService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://10.10.116.14:6888/ormrpc/services/EASLogin", "EASLogin"));
        }
