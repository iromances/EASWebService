...
public class WSWSVoucherSoapBindingStub extends org.apache.axis.client.Stub implements mypackage.WSWSVoucherSrvProxy {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "voucherCols"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://10.10.116.14/ormrpc/services/WSWSVoucher", "ArrayOf_tns1_WSWSVoucher"), mypackage.WSWSVoucher[].class, false, false);
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://10.10.116.14/ormrpc/services/WSWSVoucher", "ArrayOf_tns2_WSWSRtnInfo"));
        oper.setReturnClass(mypackage.WSWSRtnInfo[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "importVoucherReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://10.10.116.14/ormrpc/services/WSWSVoucher", "fault"),
                      "mypackage.WSInvokeException",
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://10.10.116.14/ormrpc/services/WSWSVoucher", "ArrayOfArrayOf_xsd_string"));
    ...
    public WSWSVoucherSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.1");
            ...
            qName = new javax.xml.namespace.QName("http://10.10.116.14/ormrpc/services/WSWSVoucher", "ArrayOf_tns1_WSWSVoucher");
            cachedSerQNames.add(qName);
            cls = mypackage.WSWSVoucher[].class;
            ...
            qName = new javax.xml.namespace.QName("http://10.10.116.14/ormrpc/services/WSWSVoucher", "ArrayOf_tns2_WSWSRtnInfo");
            cachedSerQNames.add(qName);
            cls = mypackage.WSWSRtnInfo[].class;
            cachedSerClasses.add(cls);
            ...
            qName = new javax.xml.namespace.QName("http://10.10.116.14/ormrpc/services/WSWSVoucher", "ArrayOfArrayOf_xsd_string");
            cachedSerQNames.add(qName);
            ...
            cachedSerQNames.add(qName);
            cls = mypackage.WSInvokeException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {voucherCols, new java.lang.Boolean(isTempSave), new java.lang.Boolean(isVerify), new java.lang.Boolean(hasCashflow)});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (mypackage.WSWSRtnInfo[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (mypackage.WSWSRtnInfo[]) org.apache.axis.utils.JavaUtils.convert(_resp, mypackage.WSWSRtnInfo[].class);
            }
        }
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof mypackage.WSInvokeException) {
              throw (mypackage.WSInvokeException) axisFaultException.detail;
         }
   }
  throw axisFaultException;
    ...
    public java.lang.String[][] importVoucher(mypackage.WSWSVoucher[] voucherCols, int isVerify, int isImpCashflow) throws java.rmi.RemoteException, mypackage.WSInvokeException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {voucherCols, new java.lang.Integer(isVerify), new java.lang.Integer(isImpCashflow)});
