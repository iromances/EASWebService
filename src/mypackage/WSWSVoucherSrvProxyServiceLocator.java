...
public class WSWSVoucherSrvProxyServiceLocator extends org.apache.axis.client.Service implements mypackage.WSWSVoucherSrvProxyService {
    ...
    private java.lang.String WSWSVoucher_address = "http://10.10.116.14:6888/ormrpc/services/WSWSVoucher";
    ...
    public mypackage.WSWSVoucherSrvProxy getWSWSVoucher() throws javax.xml.rpc.ServiceException {
    ...
    public mypackage.WSWSVoucherSrvProxy getWSWSVoucher(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.WSWSVoucherSoapBindingStub _stub = new mypackage.WSWSVoucherSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypackage.WSWSVoucherSrvProxy.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.WSWSVoucherSoapBindingStub _stub = new mypackage.WSWSVoucherSoapBindingStub(new java.net.URL(WSWSVoucher_address), this);
                _stub.setPortName(getWSWSVoucherWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://10.10.116.14/ormrpc/services/WSWSVoucher", "WSWSVoucherSrvProxyService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://10.10.116.14/ormrpc/services/WSWSVoucher", "WSWSVoucher"));
        }
